...
<script>
    // Select all interactive parts with the "room" class
    const rooms = document.querySelectorAll('.room');

    // Add a click event listener to each element
    rooms.forEach(room => {
        room.addEventListener('click', () => {
            // Show an alert with the ID of the clicked element
            alert(`You clicked on: ${room.id}`);
        });
    });
</script>
<script>
...
fetch("../svg/1GroundFloor_final.svg")
